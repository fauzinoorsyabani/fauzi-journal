    ...
    <main>
      <section className="relative flex min-h-[100svh] items-end overflow-hidden bg-[#080808] pb-8 pt-24 sm:pb-10 lg:pb-14">
        ...
        <div className="page-shell relative z-10 grid w-full gap-8 lg:grid-cols-[minmax(0,1.25fr)_minmax(15rem,.75fr)] lg:items-end">
          <div className="max-w-4xl">
            ...
            <h1 className="reveal-up-delay max-w-4xl font-display text-[clamp(2.7rem,6.2vw,6.3rem)] leading-[0.86] tracking-[-0.06em] text-[#f8f5ef]">{featured.title}</h1>
          </div>
      ...
      <section id="stories" className="bg-[#f3f0ea] py-16 text-[#121110] sm:py-24 lg:py-32">
        <div className="page-shell">
          <div className="mb-12 grid gap-6 border-b border-black/15 pb-7 sm:mb-16 sm:grid-cols-[1fr_auto] sm:items-end sm:pb-9">
            <div><p className="eyebrow mb-4">Indeks jurnal</p><h2 className="max-w-3xl font-display text-[clamp(2.5rem,4.2vw,4.35rem)] leading-[0.88] tracking-[-0.055em]">Catatan kecil untuk tumbuh tanpa terburu-buru.</h2></div>
      ...
      <section id="culture" className="bg-[#080808] py-16 sm:py-24 lg:py-32">
        <div className="page-shell grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:gap-20">
          <div><p className="eyebrow mb-4">Ruang refleksi</p><h2 className="max-w-xl font-display text-[clamp(2.5rem,4.2vw,4.35rem)] leading-[0.88] tracking-[-0.055em] text-[#f3f0ea]">Belajar menjaga diri sambil tetap penasaran.</h2></div>
