      ...
      <form onSubmit={(event: FormEvent) => { event.preventDefault(); saveStory("draft"); }} className="grid gap-8">
        ...
        <div className="grid gap-5 border border-white/10 bg-[#11100f] p-5 sm:p-7">
          ...
          <div className="grid gap-4 sm:grid-cols-[1fr_auto] sm:items-end">
            <label className="grid gap-2 font-mono text-[0.58rem] uppercase tracking-[0.12em] text-[#aaa69f]">Image URL<Input required value={draft.heroImageUrl} onChange={(event) => setDraft({ ...draft, heroImageUrl: event.target.value })} className="border-white/15 bg-[#080808] text-[#f3f0ea]" placeholder="https://… or a public Vercel Blob URL" /></label>
